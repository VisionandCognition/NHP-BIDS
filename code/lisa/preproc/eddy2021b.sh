...
# ./code/bids_preprocessing_workflow.py --csv ./csv/ct_2021_nmt2_eddy.csv  |& \
#     tee ./logs/preproc/sub-${SUB}/log-preproc-eddy2021.txt

./code/subcode/bids_preproc_parallel_runs.py \
    --csv ./csv/ct_2021_nmt2_eddy2.csv \
    --subses ct_2021_nmt2_eddy2 
